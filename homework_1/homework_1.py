gi# 1. Написать функцию read_humans, которая принимает аргументом название csv-файла, и возвращает список
# словарей (персонажей), у которых species это human

# 2. Написать функцию to_json, которая принимает аргументом список словарей и название json-файла, и записывает
